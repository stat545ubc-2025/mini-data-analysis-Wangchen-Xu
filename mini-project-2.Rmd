...
```{r}
ggplot(st_games, aes(x = original_price, y = discount_rate)) +
  geom_point(alpha = 0.25) +     
  coord_cartesian(xlim = c(1, 200), ylim = c(0, 1)) +  # zooms view; does NOT drop data
  labs(title = "RQ2: Discount rate vs original price (alpha for overplotting)",
       x = "Original price",
       y = "Discount rate") +
  theme_minimal()
